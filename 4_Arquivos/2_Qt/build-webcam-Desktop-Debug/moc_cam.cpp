...
static const char qt_meta_stringdata_Cam[] = {
    "Cam\0"
};
...
const QMetaObjectExtraData Cam::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Cam::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Cam,
      qt_meta_data_Cam, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Cam::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Cam))
